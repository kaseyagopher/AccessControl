...
<x-section-card title="Filtres de recherche" icon="search" color="brand" class="mb-6">
    <form method="GET" action="{{ route('superviseur.archivages') }}" class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div>
        ...
        <div class="flex items-end gap-2">
            ...
            <a href="{{ route('superviseur.archivages') }}" class="btn-secondary">Réinitialiser</a>
        </div>
    </form>
</x-section-card>
