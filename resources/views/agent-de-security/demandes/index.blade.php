...
@section('title', 'Consulter VNF')

@section('content')
<x-page-header title="Consulter infos VNF" subtitle="Gérer et traiter les visites" icon="inbox" color="amber" />
...
<div class="space-y-4">
    ...
    @empty
        <x-empty-state icon="inbox" color="amber" message="Aucune VNF." />
    @endforelse
</div>
@endsection
